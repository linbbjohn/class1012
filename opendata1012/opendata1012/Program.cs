using opendata1012.Models;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Xml.Linq;
namespace opendata1012
{
    class Program
    {
        ...
        static List<opendata1012.Models.Class1> findopendata()
        {
            List<opendata1012.Models.Class1> result = new List<Class1>();
            ...
            {
                var node = nodes[i];
                opendata1012.Models.Class1 item = new opendata1012.Models.Class1();
